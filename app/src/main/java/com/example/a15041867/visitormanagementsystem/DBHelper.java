...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTableSqlVisitInfo = "CREATE TABLE " + TABLE_VISIT_INFO +  "("
                + VISIT_INFO_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + VISIT_INFO_COLUMN_VISITOR_NRIC + " TEXT," + VISIT_INFO_COLUMN_HOST_NRIC + " TEXT,"
    ...
    public boolean checkVisitUnit(String visitUnit){
        //HashMap<String, String> user = new HashMap<String, String>();
        String selectQuery = "select "+ USER_COLUMN_Host_Unit +" from  " + TABLE_USER + " where " +
